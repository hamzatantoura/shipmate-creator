      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-6">
        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {products.map(p => (
              <Card key={p.id} className="bg-card border-border overflow-hidden group">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex gap-2 mt-3">
                    <Button variant="destructive" size="sm" className="gap-1 flex-1" onClick={() => deleteProduct(p.id)}>
