...
import { User, Phone, MapPin, CheckCircle, Clock, ChevronDown, ChevronUp, Loader2 } from "lucide-react";
...
export default function VendorShipments() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="font-display font-semibold text-lg text-foreground">الشحنات النشطة</h2>
      {shipments.length === 0 ? (
