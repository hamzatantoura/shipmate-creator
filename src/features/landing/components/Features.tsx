    ...
    <section id="features" className="py-20 sm:py-28">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <p className="text-xs uppercase tracking-[0.2em] text-primary font-semibold mb-3">المزايا</p>
          <h2 className="font-display font-bold text-3xl sm:text-4xl text-foreground tracking-tight">
            كل ما يحتاجه عملك اللوجستي في منصة واحدة
          </h2>
          <p className="mt-4 text-muted-foreground text-base sm:text-lg leading-relaxed">
            مجموعة أدوات احترافية مصممة خصيصاً لتجار سوريا وشركات الشحن — بدون تعقيد.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((f, i) => (
            ...
            >
              <div className={`absolute -inset-px bg-gradient-to-br ${f.accent} opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl`} aria-hidden />
