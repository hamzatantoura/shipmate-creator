    ...
    <section id="pricing" className="py-20 sm:py-28 bg-muted/30 border-y border-border/60">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <p className="text-xs uppercase tracking-[0.2em] text-primary font-semibold mb-3">الأسعار</p>
          <h2 className="font-display font-bold text-3xl sm:text-4xl text-foreground tracking-tight">
            خطط شفافة تنمو مع عملك
          </h2>
          <p className="mt-4 text-muted-foreground">ابدأ مجاناً وارتقِ متى احتجت — بدون عقود معقدة.</p>
        </div>
          ...
          {PRICING.map((tier, i) => (
            ...
            >
              ...
              <div className="mt-5 flex items-baseline gap-1">
                ...
                {tier.price.includes("$") && <span className="text-sm text-muted-foreground">/ شهرياً</span>}
              </div>
