  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#0f172a;padding:40px 20px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#1e293b;border-radius:16px;border:1px solid rgba(255,140,0,0.2);overflow:hidden;">
        <tr><td style="background:linear-gradient(135deg,#1e293b 0%,#0f172a 100%);padding:40px 40px 20px;text-align:center;">
          <div style="width:64px;height:64px;background:rgba(255,140,0,0.15);border-radius:16px;display:inline-block;line-height:64px;margin-bottom:16px;">
        ...
        <tr><td style="padding:20px 40px 30px;border-top:1px solid rgba(255,140,0,0.1);text-align:center;">
          <p style="color:#475569;font-size:12px;margin:0;">© ${year} صِلة — Sila. جميع الحقوق محفوظة.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
    ...
    console.error("Error in send-signup-email:", error);
